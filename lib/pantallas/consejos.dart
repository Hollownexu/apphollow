  ...
  final List<Map<String, dynamic>> elementosCarrusel = [
    {
      ...
      'texto':
          'Domina el esquive: Usa el salto y el dash para evitar ataques y mantenerte en posición para contraatacar.',
    },
    {
      'imagen': 'images/consejos/2.png',
      'texto':
          'Equipa los amuletos correctos: Usa amuletos como Manto de sombra para atravesar ataques y Concentración rápida para curarte más rápido.',
    },
    {
      'imagen': 'images/consejos/3.jpg',
      'texto':
          'Aprende los patrones de los jefes: Observa y anticipa los ataques de los jefes para evitar daño y golpear en el momento adecuado.',
    },
    {
      'imagen': 'images/consejos/4.jpg',
      'texto':
          'Usa el entorno: Aprovecha el terreno para esquivar ataques y atacar desde lugares seguros.',
    },
    {
      'imagen': 'images/consejos/5.jpg',
      'texto':
          'No te sientas presionado por avanzar rápido, Hollow Knight premia a los jugadores que exploran a fondo y dominan el entorno y los jefes. Tómate tu tiempo para mejorar y aprender de cada batalla. La paciencia es clave en este juego.',
    },
  ];
